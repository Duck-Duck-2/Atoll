...
//                .keyboardShortcut("E", modifiers: .command)
    ...
    private var rootBodyView: some View {
        ...
        .frame(
            maxWidth: dynamicNotchSize.width + (vm.notchState == .open ? 24 : 0) + (isDynamicIslandMode ? dynamicIslandShadowInset * 2 : 0),
            maxHeight: dynamicNotchSize.height + (vm.notchState == .open ? openNotchSurfaceBottomPadding : 0) + (isDynamicIslandMode ? dynamicIslandTopOffset + dynamicIslandShadowInset * 2 : currentShadowPadding),
            alignment: .top
        )
